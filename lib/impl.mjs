...
export const DEFAULTS = {
  ...
  // 正文默认放 JSON 开头（2026-09-26 改）：空正文时模型相当比例交白卷 / 只思考不作答
  // （09-23~25 实测：失败尝试 131/62/64 次，"空回复"占 114/58/67，另有"只思考"若干）；
  // 在答区落一个 `{"conform":`，生成位就在"裁决写了一半"上，续写即完整裁决。
  twinForgeContent: '{"conform":',
